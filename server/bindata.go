...
var Assets = assets.NewFileSystem(map[string][]string{"static": []string{}, "static/html": []string{"index.html"}, "static/js": []string{"page.js"}}, map[string]*assets.File{
	"bar.tmpl": &assets.File{
		Path:     "bar.tmpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1512306067, 1512306067000000000),
